...
void preencher_html() {
    snprintf(html, sizeof(html),
        ...
        "    <script>\n"
        "        // [IMPORTANTE] Coloque o IP do seu PC (onde o Python roda) aqui\n"
        "        const LOG_SERVER_URL = 'http://127.0.0.1:5000'; \n"
        "        \n"
        ...
        "            initializeHistory();\n"
        "            \n"
        "            // [NOVO] Carrega o dashboard e inicia o timer\n"
        "            updateDashboard();\n"
        "            setInterval(updateDashboard, 10000); // Atualiza a cada 10 segundos\n"
        "\n"
