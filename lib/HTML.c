...
void preencher_html() {
    snprintf(html, sizeof(html),
        ...
        "                    \n"
        "                    // Atualizar pallets nas esteiras\n"
        "                    document.getElementById('pallet-on-entry').innerHTML = \n"
        "                        data.pallet_on_entry ? '<p>ID: ' + data.pallet_on_entry + '</p>' : '';\n"
        "                    document.getElementById('pallet-on-exit').innerHTML = \n"
        "                        data.pallet_on_exit ? '<p>ID: ' + data.pallet_on_exit + '</p>' : '';\n"
        "                    \n"
        "                    // Atualizar status do eletroímã\n"
        ...
        "                    if (data.electromagnet_active) {\n"
        "                        electromagnetStatus.textContent = 'Ativado';\n"
        "                        electromagnetBtn.textContent = 'Desativar Eletroímã';\n"
        "                    } else {\n"
        "                        electromagnetStatus.textContent = 'Desativado';\n"
        "                        electromagnetBtn.textContent = 'Ativar Eletroímã';\n"
        "                    }\n"
        "                    \n"
        "                    // Atualizar coordenadas atuais\n"
        "                    document.getElementById('coord-x').value = data.current_position.x;\n"
        "                    document.getElementById('coord-y').value = data.current_position.y;\n"
        "                    document.getElementById('coord-z').value = data.current_position.z;\n"
        "                    \n"
        "                    // Atualizar layout dos racks\n"
        "                    data.rack_layout.forEach(rack => {\n"
        "                        const cell = document.querySelector('[data-position=\"' + rack.position + '\"]');\n"
        "                        if (cell) {\n"
        "                            if (rack.occupied) {\n"
    ...
    "fetch('/toggle-electromagnet', { method: 'POST' })\n"
        ".then(response => {\n"
           ...
           "     console.error('Falha ao acionar o eletroímã.');\n"
           " }\n"
       " })\n"
       " .catch(error => {\n"
